...
for delta_z in [0.05,0.1,0.15]:
    ...
    while z + delta_z < .61:
        ...
        cmd_str = "import datasets; dset = datasets.MICEDMDataset('MICE'); dset.make(1024,"+str(oversamp)+","+str(z)+","+str(z+delta_z)+",0, 100,-60,-40,write=True)"
        cmd_list.append(cmd_str)
        cmd_str = "import datasets; dset = datasets.MICERedmagicDataset('MICE'); dset.make(1024,"+str(oversamp)+","+str(z)+","+str(z+delta_z)+",0, 100,-60,-40,write=True)"
        cmd_list.append(cmd_str)
